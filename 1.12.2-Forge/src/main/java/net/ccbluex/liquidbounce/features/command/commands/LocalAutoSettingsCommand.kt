...
class LocalAutoSettingsCommand : Command("config2", "localsetting", "localsettings", "localconfig") {
    /**
    ...
    override fun execute(args: Array<String>) {
        if (args.size > 1) {
            when {
                ...
                args[1].equals("save", ignoreCase = true) -> {
                    ...
                    chatSyntax("config2 save <name> [all/values/binds/states]...")
                    return
                }
                ...
                args[1].equals("delete", ignoreCase = true) -> {
                    ...
                    chatSyntax("config2 delete <name>")
                    return
                }
        ...
        chatSyntax("config2 <load/save/list/delete>")
    }
