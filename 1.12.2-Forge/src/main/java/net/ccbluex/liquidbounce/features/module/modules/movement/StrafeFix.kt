...
@ModuleInfo(name = "StrafeFix", category = ModuleCategory.MOVEMENT,chinesename = "花雨庭杀戮Strafe优化", description = "CaoNiMa")
class StrafeFix : Module() {

    private val silentFixVaule = BoolValue("Silent-静默", true)
