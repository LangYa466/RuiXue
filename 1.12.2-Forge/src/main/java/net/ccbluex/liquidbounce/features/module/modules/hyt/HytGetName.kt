...
@ModuleInfo(name = "HytGetNameOLD", description = "已修复:)",chinesename = "花雨庭防假人老版本", category = ModuleCategory.VULGAR)
                ...
                "4v4/1v1" -> {
                    ...
                    if (matcher.find()) {
                        ...
                        if (name != "") {
                            ...
                            ClientUtils.displayChatMessage("§7[神秘人]§fAdd HYT Bot:$name")
                            Thread {
                                try {
                                    Thread.sleep(5000)
                                    LiquidBounce.fileManager.friendsConfig.removeFriend(name)
                                    ClientUtils.displayChatMessage("§7[神秘人]§fDeleted HYT Bot:$name")
