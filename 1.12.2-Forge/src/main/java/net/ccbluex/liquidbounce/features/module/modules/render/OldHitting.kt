...
@ModuleInfo(name = "OldHitting", description = "faq",chinesename = "右键防砍动画", category = ModuleCategory.RENDER)
class OldHitting : Module() {
    private val modeValue = ListValue("Mode", arrayOf("MineCraft", "Reverse", "Strange","ETB", "Test","Swank", "Jello", "SigmaOld","Zoom","Push", "SideDown"), "MineCraft")
