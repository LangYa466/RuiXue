...
@ModuleInfo(name = "NoFall", description = "Prevents you from taking fall damage.", chinesename = "无摔落伤害",category = ModuleCategory.PLAYER)
class NoFall : Module() {
    @JvmField
    val modeValue = ListValue("Mode", arrayOf("AAC4","SpoofGround","Hyt", "NoGround", "Packet", "MLG", "AAC", "LAAC", "AAC3.3.11", "AAC3.3.15", "Spartan", "CubeCraft", "Hypixel"), "SpoofGround")
            ...
            "aac" -> {
                ...
                "hyt" -> {
                    if (mc.thePlayer!!.isAirBorne) {
                        ...
                        } else if (mc.thePlayer!!.motionY > 0 && !mc.gameSettings.keyBindJump.isKeyDown) {
