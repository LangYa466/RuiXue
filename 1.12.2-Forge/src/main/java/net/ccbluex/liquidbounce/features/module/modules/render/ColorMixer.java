...
public class ColorMixer extends Module {
    ...
    */
    ...
    public static final ColorElement col1RedValue = new ColorElement(1, ColorElement.Material.RED);
    public static final ColorElement col1GreenValue = new ColorElement(1, ColorElement.Material.GREEN);
    public static final ColorElement col1BlueValue = new ColorElement(1, ColorElement.Material.BLUE);

    public static final ColorElement col2GreenValue = new ColorElement(2, ColorElement.Material.GREEN);
    public static final ColorElement col2BlueValue = new ColorElement(2, ColorElement.Material.BLUE);
