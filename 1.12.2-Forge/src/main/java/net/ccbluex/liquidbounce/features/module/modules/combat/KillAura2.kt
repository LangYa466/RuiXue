...
@ModuleInfo(name = "KillAura2", description = "Automatically attacks targets around you.",chinesename = "杀戮光环2",
...
class KillAura2 : Module() {
    ...
    // CPS - Attack speed
    private val maxCPS: IntegerValue = object : IntegerValue("MaxCPS", 13, 1, 20) {
    ...
    private val throughWallsRangeValue = FloatValue("ThroughWallsRange", 2f, 0f, 8f)
    private val rangeSprintReducementValue = FloatValue("RangeSprintReducement", 0f, 0f, 0.4f)

    // Modes
    private val priorityValue = ListValue("Priority", arrayOf("Health", "Distance", "Direction", "LivingTime"), "Distance")
    private val targetModeValue = ListValue("TargetMode", arrayOf("Single", "Switch", "Multi"), "Multi")
