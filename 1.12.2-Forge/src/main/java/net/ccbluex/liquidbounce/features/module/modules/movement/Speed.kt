...
import net.ccbluex.liquidbounce.features.module.modules.movement.speeds.intave.HytHop
...
@ModuleInfo(name = "Speed", description = "Allows you to move faster.", chinesename = "速度", category = ModuleCategory.MOVEMENT)
class Speed : Module() {
