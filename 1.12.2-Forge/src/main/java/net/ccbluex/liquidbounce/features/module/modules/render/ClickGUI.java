...
@ModuleInfo(name = "ClickGUI", description = "Opens the ClickGUI.",chinesename = "功能选择器",category = ModuleCategory.RENDER, keyBind = Keyboard.KEY_RSHIFT, canEnable = false)
public class ClickGUI extends Module {
    private final ListValue styleValue = new ListValue("Style", new String[] {"LiquidBounce", "Null","Astolfo", "Slowly"}, "Slowly") {
        @Override
