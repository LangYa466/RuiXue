...
@ModuleInfo(name = "AutoLeave", description = "Automatically makes you leave the server whenever your health is low.", chinesename = "原水自动逃逸", category = ModuleCategory.COMBAT)
