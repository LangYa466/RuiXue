...
import net.ccbluex.liquidbounce.utils.HWIDUtil;
...
public class FileManager extends MinecraftInstance {
    ...
    public final File cloudconfigDir = new File(dir, "https://gitcode.net/m0_62964839/vulgarsense/-/raw/master/cloudconfig/");
     ...
     * @param configs list
     */
    public void loadConfigs(final FileConfig... configs) throws IOException {
