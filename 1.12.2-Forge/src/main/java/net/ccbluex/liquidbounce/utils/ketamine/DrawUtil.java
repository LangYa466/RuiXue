...
import net.ccbluex.liquidbounce.utils.tenacity.render.StaticallySizedImage;
...
public final class DrawUtil {
    ...
    public static Vec3d interpolate(final Vec3d old, final Vec3d now, final double progress) {
        final Vec3d difVec = now.subtract(old);
        return new Vec3d(old.x + difVec.x * progress,
                old.y + difVec.y * progress,
                old.z + difVec.z * progress);
    }
