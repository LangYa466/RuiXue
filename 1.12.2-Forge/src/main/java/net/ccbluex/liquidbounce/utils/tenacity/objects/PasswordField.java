package net.ccbluex.liquidbounce.utils.tenacity.objects;
    ...
    public void drawTextBox(String text, boolean password) {
        ...
        if (this.getVisible()) {
            ...
            if (!isFocused && placeholder != null && text.isEmpty()) {
               fontRenderer.drawString(placeholder, (int) placeHolderTextX, i1, textColor);
            }
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) fontRenderer.drawString(s1, (int) l, (int) i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                GlStateManager.color(1, 1, 1, 1);
                j1 = (int) fontRenderer.drawString(s.substring(j), (int) ((float) j1 + 6), (int) i1, i);
            }

            if (flag1) {
                GlStateManager.color(1, 1, 1, 1);
                if (flag2) {
                    Gui.drawRect(k1 + 4, i1 - 1, k1 + 5, i1 + 1 + fontRenderer.FONT_HEIGHT, this.cursorColor);
                } else {
                    fontRenderer.drawString("|", (int) ((float) k1 + 4), (int) i1, textColor);
                }
            }
