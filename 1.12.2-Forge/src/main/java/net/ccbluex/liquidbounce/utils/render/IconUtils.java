...
public final class IconUtils {
    ...
    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[] {readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/liquidbounce/icon16.png")), readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/liquidbounce/icon32.png"))};
        }catch(IOException e) {
            e.printStackTrace();
        }
        return null;
