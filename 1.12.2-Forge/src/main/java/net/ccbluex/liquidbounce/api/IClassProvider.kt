...
interface IClassProvider {
    ...
    fun isTileEntityShulkerBox(obj: Any?): Boolean
     fun isCpacket(obj: Any?): Boolean = obj is PacketImpl<*> &&
            (
                    obj.wrapped is CPacketPlayer  ||
                            obj.wrapped is CPacketAnimation  ||
                            obj.wrapped is CPacketPlayerDigging ||
                            obj.wrapped is  CPacketKeepAlive ||
                            obj.wrapped is  C00Handshake ||
                            obj.wrapped is  CPacketChatMessage ||
                            obj.wrapped is  CPacketCustomPayload ||
                            obj.wrapped is   CPacketHeldItemChange||
                            obj.wrapped is   CPacketEntityAction||
                            obj.wrapped is  CPacketClientStatus ||
                            obj.wrapped is  CPacketUseEntity ||
                            obj.wrapped is CPacketEncryptionResponse ||
                            obj.wrapped is   CPacketPlayerAbilities||
                            obj.wrapped is CPacketPing ||
                            obj.wrapped is  CPacketConfirmTeleport ||
                            obj.wrapped is  CPacketCloseWindow ||
                            obj.wrapped is   CPacketEnchantItem||
                            obj.wrapped is   CPacketPlayerTryUseItemOnBlock||
                            obj.wrapped is   CPacketPlayerTryUseItem||
                            obj.wrapped is   CPacketPlaceRecipe||
                            obj.wrapped is   CPacketVehicleMove||
                            obj.wrapped is   CPacketUpdateSign||
                            obj.wrapped is CPacketServerQuery ||
                            obj.wrapped is   CPacketSteerBoat||
                            obj.wrapped is   CPacketSpectate||
                            obj.wrapped is   CPacketSeenAdvancements
                    )
