...
class Chill(inst: Target): TargetStyle("Chill", inst, true) {
    ...
    override fun drawTarget(entity: IEntityLivingBase) {
        ...
        val tWidth = (45F + Fonts.font40.getStringWidth(name!!).coerceAtLeast(Fonts.sfbold80.getStringWidth(decimalFormat.format(health)))).coerceAtLeast(120F)
    ...
    override fun handleBlur(entity: IEntityLivingBase) {
        val tWidth = (45F + Fonts.font40.getStringWidth(entity.name!!).coerceAtLeast(Fonts.sfbold80.getStringWidth(decimalFormat.format(entity.health)))).coerceAtLeast(120F)
