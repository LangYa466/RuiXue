...
class Text(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    companion object {
        ...
        fun defaultClient(): Text {
            ...
            text.displayString.set( "瑞雪 | Fps:%fps% | %serverip%")
    ...
    private fun getReplacement(str: String): String? {
        ...
        return when (str) {
            ...
            "mcps" -> return CPSCounter.getCPS(CPSCounter.MouseButton.MIDDLE).toString()
            "rcps" -> return CPSCounter.getCPS(CPSCounter.MouseButton.RIGHT).toString()
            "kill" -> autoL.kill.toString()
            "win" -> autogg.win.toString()
            "totalPlayed" -> autogg.totalPlayed.toString()
...
//            "worldTime" -> return SessionUtils.getFormatWorldTime()
    ...
    override val drawElement: Border?
        get() {
            ...
            val mwc1 = Color(CustomColor.r.get(), CustomColor.b.get(), CustomColor.g.get()).rgb
            val mwc2 = Color(CustomColor.r2.get(), CustomColor.b2.get(), CustomColor.g2.get()).rgb
            if (this.Mode.get().equals("Top")) {
                when (shadowValue.get()) {
                    "Basic" -> RenderUtils.drawShadow(
                        -2.5f,
                        -2.5f,
                ...
                RenderUtils.drawGradientSideways(
                    -2.0,
                    -3.0,
                    (fontRenderer.getStringWidth(displayText) + 2).toDouble(),
                    -2.0,
                    mwc1,
                    mwc2
                )
            ...
            if (this.Mode.get().equals("Onetap")) {
                Gui.drawRect(
                    -2,
                    -5,
                    fontRenderer.getStringWidth(displayText) + 2,
            ...
            if (bord.get()) {
                if (Mode.get() == "Skeet") {
                    RenderUtils.autoExhibition(
                        -4.0,
                        -5.2,
                        (length2).toDouble(),
                        (fontRenderer.fontHeight + 1.5).toDouble(),
                        1.0
                    )
                        ...
                        RenderUtils.drawGradientSideways(
                            ...
                            when {
                                ...
                                colorMode.equals("Gident", ignoreCase = true) -> RenderUtils.getGradientOffset(
                                    ...
                                    Color(CustomColor.r2.get(), CustomColor.b2.get(), CustomColor.g2.get(), 1),
                                    (Math.abs(
                    ...
                    fontRenderer.drawString(
                        displayText, 0F, 0F, when {
                            ...
                            colorMode.equals("Gident", ignoreCase = true) -> RenderUtils.getGradientOffset(
                                ...
                                Color(CustomColor.r2.get(), CustomColor.b2.get(), CustomColor.g2.get(), 1),
                                (Math.abs(System.currentTimeMillis() / gidentspeed.get().toDouble() + counter[0]) / 10)
                            ).rgb
                        ...
                        fontRenderer.drawString(
                            ...
                            0F, when {
                                ...
                                colorMode.equals("Gident", ignoreCase = true) -> RenderUtils.getGradientOffset(
                                    ...
                                    Color(CustomColor.r2.get(), CustomColor.b2.get(), CustomColor.g2.get(), 1),
                                    (Math.abs(
                                        System.currentTimeMillis() / gidentspeed.get().toDouble() + counter[0]
                                    ) / 10)
                                ).rgb
    ...
    fun setColor(c: Color): Text {
        CustomColor.r.set(c.red)
        CustomColor.b.set(c.green)
        CustomColor.g.set(c.blue)
        return this
    }
