...
import net.ccbluex.liquidbounce.ui.client.hud.element.elements.targets.Rice
 ...
 * A target hud
 */
@ElementInfo(name = "敌对玩家信息", disableScale = true)
class Target : Element() {
    ...
    val colorModeValue = ListValue("Color", arrayOf("Custom", "Client","Rainbow", "Sky", "Slowly", "Fade", "Health"), "Custom")
