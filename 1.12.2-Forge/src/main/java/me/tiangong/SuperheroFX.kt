...
@ModuleInfo(name = "SuperheroFX", description = "Creates comic-like words as flying particles.",chinesename = "自定义攻击粒子", category = ModuleCategory.RENDER)
...
class FXParticle(val posX: Double, val posY: Double, val posZ: Double, val animHDir: Double, val animVDir: Double): MinecraftInstance() {
    private val messageString: String = listOf("TG", "love", "瑞雪", "LangYa", "鸡巴好大").random()
    ...
    private val fontHeight = Fonts.fontBangers.height
    ...
    fun draw() {
        ...
        val textY = if (mc2.gameSettings.thirdPersonView != 2) -1.0f else 1.0f
