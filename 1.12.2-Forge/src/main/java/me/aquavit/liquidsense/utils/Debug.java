...
//        RenderUtils.drawRect(itemX, sr.getScaledHeight() - 23, itemX + 22, sr.getScaledHeight() - 22, new Color(0, 165, 255));
    ...
    private void doItemRenderGLTranslate(){
        GlStateManager.translate(OldHitting.itemPosX.get(), OldHitting.itemPosY.get(), OldHitting.itemPosZ.get());
    }
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        ...
        float f1 = MathHelper.sin(MathHelper.sin(swingProgress) * 3.1415927F);
    ...
    public void Swank(float swingProgress) {
        GL11.glTranslated(-0.1, 0.15, 0.0);
        float var3 = MathHelper.sin(swingProgress * swingProgress * (float) Math.PI);
        float var4 = MathHelper.sin(MathHelper.sqrt(swingProgress) * (float) Math.PI);
        this.transformFirstPersonItem(var3 / 0.15f, var4);
        final float rot = MathHelper.sin(MathHelper.sin(var4) * 3.1415927f);
